...
public class MainController {
    ...
    private void btnCriarAction(ActionEvent event) {
        ...
        try {
            ...
            if (formula1DAO.cadastrarPiloto(formula1DTO)) {
                ...
                mostrarMensagem("Piloto cadastrado com sucesso!", "#2ECC71");
        ...
        try {
            ...
            if (piloto != null) {
                ...
                if (formula1DAO.atualizarPiloto(piloto)) {
                    ...
                    mostrarMensagem("Piloto atualizado com sucesso!", "#3498DB");
                ...
                mostrarMensagem("Selecione um piloto para atualizar.", "#747D8C");
            }
        ...
        try {
            ...
            if (piloto != null) {
                ...
                if (formula1DAO.deletarPiloto(piloto.getId())) {
                    ...
                    mostrarMensagem("Piloto deletado com sucesso!", "#E74C3C");
                ...
                mostrarMensagem("Selecione um piloto para deletar.", "#747D8C");
            }
    ...
    private void btnLimparAction(ActionEvent event) {
        ...
        try {
            ...
            mostrarMensagem("Campos limpos.", "#747D8C");
    ...
    private void carregarPilotos() {
        ...
        ObservableList<Formula1DTO> listaPilotos = FXCollections.observableArrayList();
